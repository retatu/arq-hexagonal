...
import (
	...
	"github.com/retatu/arq-hexagonal/adapters/dto"
...
func MakeProductHandlers(r *mux.Router, n *negroni.Negroni, service application.ProductServiceInterface) {
	...
	r.Handle("/product/{id}/enable", n.With(
		negroni.Wrap(enableProduct(service)))).Methods("GET", "OPTIONS")
	r.Handle("/product/{id}/disable", n.With(
		negroni.Wrap(disableProduct(service)))).Methods("GET", "OPTIONS")
}
